    ...
    >
      ...
      >
        <a
          ...
          className={`relative flex min-w-0 flex-1 items-center gap-3 ${brandClassName} md:max-w-[22rem] ${
        ...
        >
          ...
          <span className="min-w-0 truncate text-lg font-serif font-bold sm:text-2xl">
